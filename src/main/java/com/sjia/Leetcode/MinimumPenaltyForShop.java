...
public class MinimumPenaltyForShop {
    ...
    public int bestClosingTime(String customers) {
        ...
        for (int closeHour = 0; closeHour < n; closeHour++) {
            char ch = customers.charAt(closeHour);
            if (ch == 'Y') {
                curPenalty--;
            } else  {
                curPenalty++;
    ...
    public static void main(String[] args) {
        ...
        String customers = "YYYYNYYY";
        int earliestClosingHour = solution.bestClosingTime(customers);
        System.out.println("Earliest closing hour for minimum penalty: " + earliestClosingHour);
    }
