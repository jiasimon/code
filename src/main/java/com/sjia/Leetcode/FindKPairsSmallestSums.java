...
//        for ( int i= 0 ; i < k; i++) {
    ...
    // PriorityQueue<int[]> minHeap, mergeKSortedList
    // 28 ms, 98.48%; 56.4 MB, 87.57%
    public List<List<Integer>> kSmallestPairs_mergeKSortedList(int[] nums1, int[] nums2, int k) {
        List<List<Integer>> result = new ArrayList<>();
